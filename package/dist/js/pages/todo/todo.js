...
$(".add-tsk").click(function (e) {
  ...
  $html =
    ...
    '"></label>' +
    "<div>" +
    '<h5 class="font-weight-medium fs-4 todo-header" data-todo-header="' +
    $_task +
    '">' +
    $_task +
    "</h5>" +
    "<div class='todo-subtext text-muted fs-3' data-todosubtext-html='" +
    ...
    $_taskDescriptionText +
    "</div>" +
    '<span class="todo-time fs-2 text-muted"><i class="icon-calender me-1"></i>' +
    today +
    "</span>" +
    "</div>" +
    '<div class="ms-auto">' +
    ...
    '<a class="edit dropdown-item" href="javascript:void(0);"><i class="fas fa-edit text-info me-1"></i> Edit</a>' +
    '<a class="important dropdown-item" href="javascript:void(0);"><i class="fas fa-star text-warning me-1"></i> Important</a>' +
